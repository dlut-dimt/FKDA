% ============== FKDA_X_Novelty_Detection(Demo_Caltech256) ============== %
% "Novelty Detection and Online Learning for Chunk Data Streams"          %
% Y. Wang, Y. Ding, X. He, X. Fan, H. Bai, F. Li, T. Wang, Z. Luo, J. Luo %
% TPAMI-2019-02-0102                                                      %
...
%% ================== results display ========================
save(sprintf('Result/ND/Caltech256/0.7_n.mat'),'M','F','E','Err','Fp','Fe','Fn');
clear
clc 