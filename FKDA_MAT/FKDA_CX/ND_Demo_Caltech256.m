% ============= FKDA_CX_Novelty_Detection(Demo_Caltech256) ============== %
...
K_cm_inv = pinv(K_cm); % the inverse matrix of the kernel matrix
...
%% ================== results display ========================
save(sprintf('Result/ND/Caltech256/0.7_5.mat'),'M','F','E','Err','Fp','Fe','Fn');
clear
clc   
